...
import static com.nadyagrishina.lwjglutils.ShaderUtils.*;
...
public class OGLUtils {
	...
	public static void checkShaderCompilation(int shaderID) {
		int success = glGetShaderi(shaderID, GL_COMPILE_STATUS);
		if (success == GL_FALSE) {
			int logLength = glGetShaderi(shaderID, GL_INFO_LOG_LENGTH);
			String errorMessage = glGetShaderInfoLog(shaderID, logLength);
